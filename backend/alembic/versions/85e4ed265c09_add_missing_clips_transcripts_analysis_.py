...
def upgrade() -> None:
    # These tables are also created by the initial schema migration
    # (8cefeb075c6c). This migration was written for older databases that
    # predated those tables; on a fresh database they already exist, so
    # guard every create with an existence check to stay idempotent.
    bind = op.get_bind()
